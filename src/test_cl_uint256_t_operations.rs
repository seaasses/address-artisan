...
mod tests {
    ...
    impl Uint256Operations {
        pub fn new() -> Result<Self, String> {
            ...
            let src = include_str!(concat!(env!("OUT_DIR"), "/uint256Operations"));
        ...
        fn sub_with_underflow_flag(
            &mut self,
            a: Vec<u8>,
            b: Vec<u8>,
        ) -> Result<(Vec<u8>, bool), String> {
            let (result, underflow_flag) = self.run_operation(a, b, 4)?;
            Ok((result, underflow_flag))
        }
    ...
    #[test]
    fn test_uint256_t_1_minus_1_with_underflow_flag() {
        let mut ocl = Uint256Operations::new().unwrap();
        ...
        let (result, underflow_flag) = ocl.sub_with_underflow_flag(a, b).unwrap();
        assert_eq!(underflow_flag, false);
        assert_eq!(
            result,
            vec![
                0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    #[test]
    fn test_uint256_t_7_minus_3_with_underflow_flag() {
        let mut ocl = Uint256Operations::new().unwrap();
    ...
    #[test]
    fn test_uint256_t_maxu64p2_minus_4_with_underflow_flag() {
        let mut ocl = Uint256Operations::new().unwrap();
    ...
    #[test]
    fn test_uint256_t_all_e_minus_all_f() {
        let mut ocl = Uint256Operations::new().unwrap();
    ...
    #[test]
    fn test_uint256_t_4_minus_6_with_underflow_flag() {
        let mut ocl = Uint256Operations::new().unwrap();
