...
mod tests {
    ...
    pub struct Uint256Subtraction {
        ...
        uint256_subtraction_kernel: Kernel,
    }
    ...
    impl Uint256Subtraction {
        pub fn new() -> Result<Self, String> {
            ...
            // Create kernel
            let uint256_subtraction_kernel = match Kernel::builder()
                .program(&program)
                .name("uint256SubtractionKernel")
                .queue(queue.clone())
                .arg(&a_buffer)
                .arg(&b_buffer)
                .arg(&result_buffer)
        ...
        fn build_program(device: Device, context: Context) -> Result<Program, String> {
            let src = include_str!(concat!(env!("OUT_DIR"), "/uint256SubtractionKernel"));
        ...
        fn subtraction(&mut self, a: Vec<u8>, b: Vec<u8>) -> Result<Vec<u8>, String> {
            ...
            // Execute kernel
            unsafe {
                match self.uint256_subtraction_kernel.enq() {
                    Ok(_) => (),
    ...
    fn test_subtraction_1_1() {
        ...
        let result = ocl.subtraction(a, b).unwrap();
