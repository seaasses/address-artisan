...
mod tests {
    ...
    fn test_sha512_192_bytes_wealth_of_nations() {
        ...
        assert_eq!(message.len(), MESSAGE_SIZE, "Message must be exactly 192 bytes");

        let expected: Vec<u8> = vec![
            0xbf, 0x0d, 0x19, 0xb1, 0xf3, 0x6b, 0x57, 0x21,
            0x0b, 0x17, 0xab, 0x2f, 0xe3, 0x36, 0x61, 0x6b,
            0x48, 0xf5, 0x40, 0x00, 0xe7, 0xa7, 0x6b, 0x5a,
            0x31, 0xad, 0xf4, 0x66, 0x1e, 0xae, 0x36, 0x4f,
            0x1f, 0xe9, 0xd8, 0xf5, 0x52, 0xa1, 0x6d, 0xaf,
            0x8a, 0x40, 0x6c, 0x27, 0x34, 0x68, 0xcb, 0xa0,
            0xb3, 0x39, 0x82, 0x62, 0xfa, 0x35, 0x86, 0x21,
    ...
    fn test_sha512_192_bytes_hayek() {
        ...
        let expected: Vec<u8> = vec![
            0x84, 0xfd, 0x93, 0x2b, 0xb7, 0x5a, 0xf3, 0x39,
            0x1d, 0xa3, 0x78, 0xcb, 0xc8, 0xb3, 0x92, 0x41,
            0xa0, 0x8e, 0x47, 0x3e, 0x92, 0xcd, 0x22, 0xaf,
            0x23, 0x6a, 0x8b, 0x3c, 0xab, 0xa9, 0xd0, 0xed,
            0x6d, 0xe2, 0x67, 0xb9, 0x5b, 0xbf, 0xd8, 0xd1,
            0x31, 0xe9, 0x56, 0x20, 0x44, 0xfc, 0x90, 0xb6,
            0x73, 0xc3, 0xa1, 0x7b, 0x3e, 0x1d, 0x5f, 0x50,
    ...
    fn test_sha512_192_bytes_rothbard() {
        ...
        let expected: Vec<u8> = vec![
            0x32, 0xaa, 0xd1, 0xd1, 0x21, 0x51, 0x32, 0xa4,
            0xb8, 0xe7, 0xf4, 0x62, 0x53, 0xb3, 0x95, 0x9d,
            0x44, 0x5b, 0xce, 0x2d, 0xac, 0x81, 0xe1, 0xc6,
            0x45, 0x31, 0xdc, 0x7e, 0x9b, 0x87, 0xaa, 0x51,
            0xf6, 0x43, 0x11, 0xa3, 0xca, 0xf0, 0x2f, 0x95,
            0x17, 0x71, 0x2b, 0xa7, 0x25, 0xdf, 0xe7, 0x70,
            0x6d, 0xea, 0xd4, 0x26, 0x2f, 0xe5, 0x27, 0xaa,
    ...
    fn test_sha512_192_bytes_greenspan() {
        ...
        let expected: Vec<u8> = vec![
            0x96, 0xf9, 0x34, 0xc9, 0x6c, 0xfd, 0xe6, 0xed,
            0x50, 0x09, 0xce, 0x2d, 0xb1, 0x6b, 0xca, 0x52,
            0x58, 0x75, 0xfb, 0x0e, 0x09, 0xdb, 0x44, 0x13,
            0xdb, 0x07, 0xe0, 0x3e, 0x3a, 0x87, 0xdb, 0xb7,
            0x56, 0x29, 0xb3, 0x3c, 0x5e, 0xd3, 0xda, 0xd1,
            0x2e, 0x9b, 0x0b, 0xef, 0xec, 0x6f, 0xd3, 0x5f,
            0x59, 0x3d, 0xf8, 0xf4, 0x04, 0x39, 0x26, 0x8e,
