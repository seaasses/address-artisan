...
mod tests {
    ...
    impl ModularAddition {
        ...
        fn build_program(device: Device, context: Context) -> Result<Program, String> {
            let src = include_str!(concat!(env!("OUT_DIR"), "/modularAdditionKernel"));
    ...
    #[test]
    fn test_addition_p_minus_1_plus_1() {
        let mut ocl = ModularAddition::new().unwrap();
    ...
    #[test]
    fn test_addition_p_minus_1_plus_2() {
        let mut ocl = ModularAddition::new().unwrap();
    ...
    #[test]
    fn test_addition_big_numbers_that_pass_p_but_dont_overflow_32_bytes() {
        let mut ocl = ModularAddition::new().unwrap();
    ...
    #[test]
    fn test_addition_big_numbers_that_overflow_32_bytes() {
        let mut ocl = ModularAddition::new().unwrap();
