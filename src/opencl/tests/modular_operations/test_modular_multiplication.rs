...
mod tests {
    ...
    #[test]
    fn test_modular_multiplication_alternating_words() {
        // Alternating 32-bit words maximize cross-limb carries in the 8x8 Comba
        // and the fold. a = 0xffffffff00000000..., b = 0x00000000ffffffff...
        let mut ocl = ModularMultiplication::new().unwrap();
        let a = vec![
        ...
        let expected = vec![
            0x00, 0x00, 0x03, 0xd5, 0xff, 0xff, 0xf8, 0x5b, 0x00, 0x00, 0x0b, 0x73, 0xff, 0xff,
            0xf0, 0xbd, 0x00, 0x00, 0x13, 0x11, 0xff, 0xff, 0xe9, 0x1f, 0x00, 0x00, 0x1a, 0xb0,
            0xff, 0xff, 0xe5, 0x49,
        ];
        assert_eq!(ocl.multiplication(a, b).unwrap(), expected);
    }
