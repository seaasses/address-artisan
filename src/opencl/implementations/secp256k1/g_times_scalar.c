...
inline JacobianPoint g_times_scalar(const Uint256 scalar)
{
    ...
    ulong is_not_first_non_zero_window = 0;
    ...
    for (uchar limb_index = 0; limb_index < 4; ++limb_index)
    {
        ...
        for (uchar i = 0; i < 8; ++i)
        {
            ...
            mask_do_not_sum_g_times_window = -(((ulong)(!window_is_not_zero)) & is_not_first_non_zero_window); // mask
