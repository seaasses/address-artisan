...
// Reduces a full 512-bit value modulo the secp256k1 prime using two folds
// with P_FOLDING_CONSTANT (2^256 = P_FOLDING_CONSTANT mod p) followed by one
// conditional subtraction. Valid for ANY Uint512 input; the result is fully
// reduced (< p).
