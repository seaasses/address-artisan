...
mod tests {
    ...
    impl ModularOperations {
        pub fn new() -> Result<Self, String> {
            ...
            let src = include_str!(concat!(env!("OUT_DIR"), "/modularOperations"));
        ...
        fn modular_subtraction(&mut self, a: Vec<u8>, b: Vec<u8>) -> Result<Vec<u8>, String> {
            let result = self.run_operation(a, b, 3).unwrap();
            Ok(result)
        }
        fn modulus(&mut self, a: Vec<u8>) -> Result<Vec<u8>, String> {
            let result = self.run_operation(a, vec![0; 32], 4).unwrap();
            Ok(result)
        }

        fn modular_double(&mut self, a: Vec<u8>) -> Result<Vec<u8>, String> {
            let result = self.run_operation(a, vec![0; 32], 5).unwrap();
            Ok(result)
        }
    ...
    fn test_modulus_1() {
        ...
        let result = ocl.modulus(a).unwrap();
    ...
    fn test_modulus_p_minus_1() {
        ...
        assert_eq!(result, SECP256K1_P_MINUS_1.to_vec());
    }
    ...
    #[test]
    fn test_modulus_p_plus_1() {
        let mut ocl = ModularOperations::new().unwrap();

        let a = SECP256K1_P_PLUS_1.to_vec();
    ...
    #[test]
    fn test_modular_addition_1_plus_1() {
        let mut ocl = ModularOperations::new().unwrap();
    ...
    #[test]
    fn test_modular_addition_p_minus_1_plus_p_minus_1() {
        let mut ocl = ModularOperations::new().unwrap();
    ...
    #[test]
    fn test_modular_addition_add_zero() {
        let mut ocl = ModularOperations::new().unwrap();
    ...
    #[test]
    fn test_modular_addition_large_numbers_overflowing() {
        let mut ocl = ModularOperations::new().unwrap();

        let a = vec![
            0x08, 0xa4, 0xa7, 0x49, 0xb9, 0x57, 0x47, 0x1b, 0xd4, 0xa7, 0x95, 0xd7, 0x64, 0xc7,
            0x18, 0xb4, 0x33, 0x22, 0x5b, 0x30, 0xc4, 0x5d, 0x7a, 0x9e, 0x32, 0xc0, 0x8b, 0xde,
            0x1c, 0x82, 0x77, 0x89,
        ];

        let b = vec![
            0xfb, 0xb8, 0xb0, 0x56, 0x4e, 0x6b, 0x55, 0x21, 0xf7, 0xf0, 0x0a, 0xfa, 0xab, 0x8f,
            0xb1, 0xb5, 0xc8, 0x10, 0x8a, 0x0f, 0x85, 0x5c, 0x77, 0x1a, 0x49, 0x15, 0x17, 0xed,
            0x27, 0x75, 0x6b, 0xd2,
        ];

        let expected = vec![
            0x04, 0x5d, 0x57, 0xa0, 0x07, 0xc2, 0x9c, 0x3d, 0xcc, 0x97, 0xa0, 0xd2, 0x10, 0x56,
            0xca, 0x69, 0xfb, 0x32, 0xe5, 0x40, 0x49, 0xb9, 0xf1, 0xb8, 0x7b, 0xd5, 0xa3, 0xcc,
            0x43, 0xf7, 0xe7, 0x2c,
        ];
    ...
    #[test]
    fn test_modular_addition_large_numbers() {
        let mut ocl = ModularOperations::new().unwrap();
    ...
    // TEST - MODULAR SHIFT LEFT (MODULAR DOUBLE)
    #[test]
    fn test_modular_double_1() {
        let mut ocl = ModularOperations::new().unwrap();
        ...
        let result = ocl.modular_double(a).unwrap();
        assert_eq!(result, expected);
    }

    #[test]
    fn test_modular_double_p_minus_1() {
        let mut ocl = ModularOperations::new().unwrap();
    ...
    #[test]
    fn test_modular_double_big_number() {
        let mut ocl = ModularOperations::new().unwrap();

        let a = vec![
            0x9a, 0x0a, 0x97, 0x4f, 0xb0, 0xf8, 0xac, 0x33, 0xef, 0x77, 0xa1, 0x50, 0x56, 0xe3,
            0xe9, 0x7e, 0x93, 0xd4, 0xc4, 0x2c, 0x56, 0x67, 0x7b, 0x76, 0x7e, 0x4c, 0x0b, 0x2b,
            0xc1, 0x20, 0x58, 0x97,
        ];

        let expected = vec![
            0x34, 0x15, 0x2e, 0x9f, 0x61, 0xf1, 0x58, 0x67, 0xde, 0xef, 0x42, 0xa0, 0xad, 0xc7,
            0xd2, 0xfd, 0x27, 0xa9, 0x88, 0x58, 0xac, 0xce, 0xf6, 0xec, 0xfc, 0x98, 0x16, 0x58,
            0x82, 0x40, 0xb4, 0xff,
        ];
    ...
    // #[test]
    // fn test_modular_multiplication_2_times_3() {
    //     let mut ocl = ModularOperations::new().unwrap();
    ...
    // #[test]
    // fn test_modular_multiplication_8_bytes_filled() {
    //     let mut ocl = ModularOperations::new().unwrap();
    ...
    // #[test]
    // fn test_modular_multiplication_16_bytes_filled() {
    //     let mut ocl = ModularOperations::new().unwrap();
    ...
    //     let result = ocl.modular_subtraction(a, b).unwrap();
    //     assert_eq!(result, expected);
    // }
